...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.fragmentContainer, filtersFragment).commit();
        ...
        ItemsApiService.getInstance().getItemsBySchool(user_school).enqueue(new Callback<List<Item>>() {
            ...
            public void onResponse(@NonNull Call<List<Item>> call, @NonNull Response<List<Item>> response) {
                ...
                for(Item i: response.body()){
                    items.add(new Item(i.getName(), i.getDescription(),i.getSubject(), i.getImage1(),null, null, i.getGrade(), i.getRecognized_text(), i.getUser_id(), i.getSchool()));
                }
